...
`js/support-config.js` holds every donation surface. Each one stays completely
hidden until you fill in the matching account name (GitHub Sponsors, Ko-fi,
Buttondown newsletter, supporters wall) — the site never shows a broken link.
